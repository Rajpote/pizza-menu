...
function Footer() {
   ...
   return <footer className="footer">{isOpen ? <Order closeHour={closeHour} openHour={openHour} /> : <p>we are closed</p>}</footer>;
...
function Order({ openHour, closeHour }) {
   return (
      <div className="order">
         <p>
            we are open from {openHour}:00 until {closeHour}:00 hours
         </p>
